    ...
    <main class="auth-container">
        <div class="auth-wrapper">
            ...
            <div class="auth-right">
                ...
                <!-- Login Form -->
                <form action="<?php echo e(route('login')); ?>" method="post" class="auth-form active" id="loginForm">
                    <?php echo csrf_field(); ?>
                ...
                <!-- Register Form -->
                <form action="<?php echo e(route('login')); ?>" method="post" class="auth-form" id="registerForm">
                   <?php echo csrf_field(); ?>
...
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/sorokin/Documents/Laravel12Test/resources/views/website_section/auth.blade.php ENDPATH**/ ?>